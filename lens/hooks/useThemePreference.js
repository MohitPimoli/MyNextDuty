 ...
 * when `matchMedia` is unavailable or throws.
 *
 ...
 * from the OS preference, defaulting to light. All `localStorage`
 ...
 * continues without error. The selection is persisted so it reapplies
 * on later visits , and only the two selectable themes are ever
 * produced.
 *
 * @returns {{
 *   theme: "light" | "dark",

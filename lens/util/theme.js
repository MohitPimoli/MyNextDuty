...
/**
 * The two selectable themes (Req 2.1).
 * @type {ReadonlyArray<"light" | "dark">}
 */
export const THEMES = ["light", "dark"];

/** The default theme applied when no preference is detectable (Req 2.5). */
export const DEFAULT_THEME = "light";

/** The client-side storage key used to persist the selected theme (Req 2.3). */
export const THEME_STORAGE_KEY = "theme";

/**
 * Toggle between the two themes (Req 2.2).
 *
 ...
 * theme when no OS preference is detectable (Req 2.4, 2.5).
 *
 ...
 * callers can fall back to the OS preference for the session (Req 2.3, 2.4).
 *

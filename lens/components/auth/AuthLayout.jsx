...
/**
 * Auth screen split layout (Req 6.1, 6.6).
 *
...
const AuthLayout = ({ children, illustration }) => {
    return (
        <div className="flex min-h-[calc(100vh-4rem)] w-full">
            ...
            >
                <div className="w-full max-w-md space-y-spacing-3">
                    {children}
                </div>
            </div>
        </div>
...
const DefaultIllustration = () => (
    <div className="flex flex-col items-center text-center space-y-spacing-3 max-w-sm">

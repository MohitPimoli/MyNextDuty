...
const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Auth failure: retain email/username, clear password
  ...
  if (success) {
    return (
      <div className="space-y-spacing-3 text-center">
        ...
        <p className="text-body text-text-secondary">Redirecting you to login...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-3 space-y-spacing-3">
      ...
      <div className="space-y-spacing-1">
        ...
        <p className="text-xl text-text-secondary">Start discovering your next step today</p>
      </div>
          ...
          {fields
            ...
            .map((field) => (
              <div key={field.name} className="flex flex-col gap-0.5 space-y-1">
                ...
                >
                  {field.label}
                  {!field.required && <span className="text-text-secondary ml-1">(optional)</span>}
                </label>
                <Input
